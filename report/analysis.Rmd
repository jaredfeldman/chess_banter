...
1. Opponent does not speak english (our language used in treatment).
1. Opponent does not see the chat due to screen resolution or device used.
1. Opponent does not want to engage in chat.
