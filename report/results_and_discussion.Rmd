...
```{r}
rating_maia_win           <- exp_data_c_t[ , lm(maia_win ~ opp_rating)]
rating_maia_mate           <- exp_data_c_t[ , lm(maia_checkmate ~ opp_rating)]
rating_opp_mate          <- exp_data_c_t[ , lm(opp_checkmate ~ opp_rating)]
rating_opp_resign           <- exp_data_c_t[ , lm(opp_resign ~ opp_rating)]
rating_draw         <- exp_data_c_t[ , lm(draw ~ opp_rating)]
rating_opp_acc           <- exp_data_c_t[ , lm(opp_acc ~ opp_rating)]
rating_opp_blunders           <- exp_data_c_t[ , lm(opp_blunders ~ opp_rating)]
rating_opp_mistakes       <- exp_data_c_t[ , lm(opp_mistakes ~ opp_rating)]
rating_opp_acpl           <- exp_data_c_t[ , lm(opp_acpl ~ opp_rating)]
rating_opp_move_time           <- exp_data_c_t[ , lm(opp_avg_move_time ~ opp_rating)]
...
```{r}
hist(predict(rating_maia_win))
```

```{r}
table(exp_data_c_t$maia_win)
```
