...
ggplot(exp_data, aes(x = opp_rating, color = factor(chat_type))) +
  ...
  labs(title = "Experiment 1: Opponent Rating by Chat Type",
...
ggplot(exp_data_gpt, aes(x = opp_rating, color = factor(chat_type))) +
  geom_density(alpha = 0.5) +
  labs(title = "Experiment 2: Opponent Rating by Chat Type",
       x = "Opponent Rating", y = "Density") +
